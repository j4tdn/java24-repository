...
public class Ex01StringImmutableDemo {
	...
	public static void main(String[] args) {
		...
		String o2 = new String("hello").intern();
		...
		// 100% --> String literal
		// Immutable --> Dù là String Object, Literal thì 1 ô nhớ được tạo ra để lưu trữ giá trị của String thì ko bao giờ cập nhật được
	}
