...
public class Ex01ObjectCompareDemo {
	 ...
	 * 
	 * + KDL đối tượng: --> .equals(o) : Hàm ở class 'Object' sau đó sẽ override lại
	 * : Mặc định so sánh với toán tử == (stack) : Mong muốn so sánh giá trị của đối
	 * tượng ==> 2 đối tượng sẽ equals với nhau khi nào ?? tự định nghĩa
	 * 
	 * --> .compareTo(o): Hàm ở interface Comparable<T> sau đó sẽ override lại : Mặc
	 * định là hàm trừu tượng
	 */
