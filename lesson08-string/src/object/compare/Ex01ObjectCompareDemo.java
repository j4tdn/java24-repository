...
public class Ex01ObjectCompareDemo {
	...
	/*
	 ...
	 + KDL đối tượng:
	 	...
	 	--> .compareTo(o) : Hàm ử interface Comparable<T> sau đó sẽ override lại
	...
	public static void main(String[] args) {
		...
		// So sánh lớn bé
		System.out.println("comapreTo(i3,i5) --> " + i3.compareTo(i5));
		System.out.println("comapreTo(i1,i3) --> " + i1.compareTo(i3));
		System.out.println("comapreTo(i4,i2) --> " + i4.compareTo(i2));
		...
		System.out.println("cqt(s1,s2): --> " + s1.compareTo(s2));
		System.out.println("cqt(s1,s3): --> " + s1.compareTo(s3));
