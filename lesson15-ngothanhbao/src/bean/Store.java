...
/**
 * Store: Cửa hàng + id: mã cửa hàng + desc: mô tả + potential: số mặt hàng cần
 * có để bán + whId: mã kho, kho hàng chuyển mặt hàng đến cửa hàng
 */
public class Store {
	...
	public Store(Integer whId, BigDecimal potential) {
		this.potential = potential;
		this.whId = whId;
	}
