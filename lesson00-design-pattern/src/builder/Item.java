 ...
 * Muốn Item immutable --> chỉ tạo hàm getter, ko tạo hàm setter
 * 
 * Class nằm bên trong Class --> nested class Hàm nằm trong hàm --> nested
 * function
 * 
 * Builder là static class vì + nếu non-static, muốn truy cập được Builder thì
 * phải tạo 1 đối tượng Item (ko hợp lý, vì nếu tạo đối tượng Item thì ko cần
 * dùng Builder, dùng Builder để tạo đối tượng) + tạo đối builder thông
 * Item.builder()
 */
public class Item {
