...
public class F1Item {
	...
	public F1Item(int id, String name, Double salesPrice, Double buyPrice, Double tax, int amount,
	...
	/*
	 * public Item(Double buyPrice, Double tax) { this.buyPrice = buyPrice; this.tax
	 * = tax; }
	 * 
	 * public Item(Double salesPrice, Double tax) { this.salesPrice = salesPrice;
	 * this.tax = tax; }
	 */
