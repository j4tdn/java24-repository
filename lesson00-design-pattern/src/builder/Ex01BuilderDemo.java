...
public class Ex01BuilderDemo {
	public static void main(String[] args) {
		...
		AdvItem advItem1 = AdvItem.of() // AdvItem
				.withId(555).withName("AdvItem 555").withExpiredDate(LocalDate.now().plusDays(14)).withSalesPrice(22d);
		...
		PvItem pvItem = PvItem.of() // PvItem
				.withId(555).withName("PvItem 567").withExpiredDate(LocalDate.now().plusDays(14)).withSalesPrice(22d);
