...
public class Ex04Exercises {
	...
	public static void main(String[] args) {
		...
		// 3. In thông tin các ngày trong tháng, tuần hiện tại dd/MM/yyyy week_day
		printDaysInMonth(c);
		printDaysInWeek(c);
		
		// 4. Đếm xem trong tháng có bao nhiêu ngày chủ nhật và in ra
		Calendar[] sundays = getSunday(c);
		System.out.println("\nSố ngày chủ nhật --> " + sundays.length);
	...
	private static Calendar[] getSunday(Calendar source) {
