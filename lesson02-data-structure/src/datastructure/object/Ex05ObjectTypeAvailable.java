...
public class Ex05ObjectTypeAvailable {
	...
	public static void main(String[] args) {
		...
		// sử dụng, in ra
		// char --> kí tự
		// byte --> số trong bảng mã ASCII tương ứng với ký tự
		char c1 = 66;
		byte c2 = 'A';
		...
		// Với KDT đối tượng có sẵn của JAVA
		// Integer, Long, String, Double ...
		// Ko cần phải dùng new mà có thể gán trực tiếp giá trị cho biến đối tượng
		
		// Vì KDL có sẵn có duy nhất 1 thuộc tính
		// Thay vì new đối tượng rồi set giá trị thì chỉ cần gán giá trị còn việc new và set thì JAVA tự làm
