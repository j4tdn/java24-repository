...
public class Ex05Throws {
	/*
	 	...
	 	+ Khi trong hàm có ném ra runtime exception thì chỗ gọi nó không bắt buộc phải xử lý
	 	(nhưng phải xử lý) 
	 	Compile exception : Là class Exception, IOException và các class con của nó
	 	+ Khi trong hàm có ném ra compile exception thì chỗ gọi nó bắt buộc phải xử lý
	 	(ném tiếp/bắt)
	 */
