...
public class Ex07Finally {
	...
	public static void main(String[] args) {
		...
		String[] calcalateData = mockData(100);
		calcalateData[97] = "98, Name 98, cb";
		
		
		generate("B1. Dữ liệu sau khi tính toán", calcalateData);
		...
		// Class cơ bản dùng để ghi dử liệu vào file
		FileWriter fw = null;
		try {
			// liên kết, mở file
			...
			for (String object:calcalateData) {
		...
		// Vừa tính toán vừa ghi file, có khả năng tại 1 đối tượng, dòng dữ liệu bị lỗi
