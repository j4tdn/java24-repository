...
public class Ex04ArrayListPrinciple {
	...
	public static void main(String[] args) {
		/*
		 ...
		 + ArrayList: là 1 class của Java trong bộ collection có attribute là 1D
		 			  khi thêm 1 element vào AL thực ra là đang thêm vào mảng thao tác
		 			  trên mảng đó, use các func sp của AL
