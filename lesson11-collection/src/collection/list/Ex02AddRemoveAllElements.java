...
public class Ex02AddRemoveAllElements {
	...
	public static void main(String[] args) {
		...
		generate("kết quả hợp nhau", unionAll);
		
		//Giao
		List<String> intersect = new ArrayList<String>(list1);
		intersect.retainAll(list2);
		generate("Kết quả giao nhau", intersect);
		
		//Hiệu
		List<String> removeAll = new ArrayList<String>(list1);
		removeAll.removeAll(list2);
		generate("Kết quả hiệu nhau", removeAll);
