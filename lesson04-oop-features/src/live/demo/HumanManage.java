...
public class HumanManage {
	...
	public static void main(String[] args) {
		...
		Leader ld1 = new Leader("Nam", LocalDate.of(1990, Month.AUGUST, 20), 13d, 5d, "VP1");
		...
		System.out.println("Tien luong st1: " + st1.salaryInDouble());
		System.out.printf("Tien luong ld1: %.1f",ld1.salaryInDouble());
	}
