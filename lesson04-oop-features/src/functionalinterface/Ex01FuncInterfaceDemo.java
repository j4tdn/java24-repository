...
public class Ex01FuncInterfaceDemo {
	...
	public static void main(String[] args) {
		...
		// nhưng mà lúc override không khai báo tên hàm, kdl trả về mà chỉ thêm ->
		 ...
		 * với anonymous function, lúc override 
		  + không cần điền KDL truyền vào của tham
		  + nếu số lượng tham số trong hàm override chỉ có 1 tham số --> bỏ luôn ()
		  + nếu phần body override chỉ có 1 dòng ode --> bỏ luôn {}, khi bỏ {} nếu hàm
