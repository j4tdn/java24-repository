...
public class Ex02MethodReference {
	...
	public static void main(String[] args) {
		...
		// // Dang 1: (T t...) -> class/object.method(t..) --> class/object::method
		...
		inventory.sort((a1, a2) -> a1.getCountry().compareTo(a2.getCountry()));
		...
		// (a1, a2) -> a1.getCountry().compareTo(a2.getCountry())
