...
public class Ex02MethodReference {
	...
	public static void main(String[] args) {
		...
		// 1: (T t...) -> class/object.method(t..) --> class/object::method
		...
		// Lưu ý: sp nulls first/last cho obj đang sort
		// : ko sp xử lý null cho thuộc tính của obj, tự xử lý

		// VD:sort asc theo country, weight
		...
		/*
		 * inventory.sort((a1, a2) -> { int countryInt =
		 * a1.getCountry().compareTo(a2.getCountry());
		 * 
		 * if (countryInt != 0) { return countryInt; }
		 * 
