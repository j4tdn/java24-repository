...
public class Ex03OperationAddRemove {
	public static void main(String[] args) {
		...
		/*
		 Note 
		 - Dịch sang trái, duyệt từ trái qua phải 
		 - Dịch sang phải, duyệt từ phải sang trái
		 */
		String[] words = {"a", "b", "c", "d", "e"};
		
		// Viết hàm thêm 1 phần tử vào 1 vị trí bất kỳ trong mảng 
		
		try {
			System.out.println("Thêm mới: "+Arrays.toString(add(words, 2, "w")));
		} catch (Exception e) {
	...
	private static String[] add(String[] source, int pos, String newValue) {
		...
		//B2 : Copy các phần tử source sang target đúng vị trí
