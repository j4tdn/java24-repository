...
public class Ex06BubbleSortItem {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 + Sắp xếp mảng mặt hàng tăng dần xxx
		 + Sắp xếp mảng mặt hàng tăng/giảm dần theo thuộc tính(1/N)
		 
		 VD: Sắp xếp mảng mặt hàng tăng dần theo giá bán
		 - Duyệt 2 vòng for như bình thường với bubble sort
		 - Khi so sánh 2 phần tử liền kề -> so sánh dựa trên giá trị của thuộc tính muốn so sánh
		                                 -> hoán vị 2 mặt hàng
		 */
