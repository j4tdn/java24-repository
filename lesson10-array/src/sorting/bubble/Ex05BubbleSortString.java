...
public class Ex05BubbleSortString {
	...
	public static void main(String[] args) {
		...
		/*
		 Với mảng đối tượng, có thể xảy ra trường hợp giá trị phần tử bị NULL -> NPE
		 Xử lý
		 -----
		 B1: Xử lý cho những phần tử null trước
		     --> null first, giá trị null < giá trị tồn tại
		     --> null last ,              >
		 B2: Với những cặp liền kề không có phần tử null
		     --> So sánh như bình thường(tăng/giảm dần)    
		 */
